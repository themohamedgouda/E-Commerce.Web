...
{
    public class ServicesManager(IUnitOfWork _unitOfWork, IMapper _mapper, IBasketRepository _basketRepository , UserManager<ApplicationUser> _userManager) : IServicesManager
    {
        ...
        private readonly Lazy<IAuthenticationServices> _LazyAuthenticationServices = new Lazy<IAuthenticationServices>(() => new AuthenticationServices(_userManager));
